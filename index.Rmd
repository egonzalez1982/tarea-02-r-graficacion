...
author: "Esteban Gonzalez Ramirez"
date: '2020-09-16'
output:
  html_document:
    theme: readable
...
```{r}
library(ggplot2)
ca_recuperados.ordenado <- order(ca_covid19$recuperados, decreasing=TRUE)
ca_covid19.recuperados <- ca_covid19[ca_recuperados.ordenado,]
...
```{r}
ca_activos.ordenado <- order(ca_covid19$activos, decreasing=TRUE)
ca_covid19.activos <- ca_covid19[ca_activos.ordenado,]
...
```{r}
ca_fallecidos.ordenado <- order(ca_covid19$fallecidos, decreasing=TRUE)
ca_covid19.fallecidos <- ca_covid19[ca_fallecidos.ordenado,]
